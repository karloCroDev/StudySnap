...
> = ({ triggerProps, children, title, ...rest }) => (
  <RadixDialog.Root {...rest}>
    ...
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content className="fixed left-1/2 top-1/2 z-max flex max-h-[75%] w-full -translate-x-1/2 -translate-y-1/2 flex-col gap-y-6 overflow-scroll rounded-2xl bg-gray-100 px-8 py-6 outline-none data-[state=closed]:animate-content-closed data-[state=open]:animate-content-open sm:w-5/6 md:w-desktop-dialog">
        <div>
